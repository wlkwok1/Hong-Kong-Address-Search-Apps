    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton_A.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!ButtonA) {
                    ButtonA=true;
                    ImageButton_A.setImageResource(R.drawable.close);
                    listView.setVisibility( View.VISIBLE );
                }else {
                    ImageButton_A.setImageResource(R.drawable.more);
                    ButtonA=false;
                    listView.setVisibility( View.GONE );
                }
            }
        ...
        ImageButton_B.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!ButtonB) {
                    ButtonB=true;
                    ImageButton_B.setImageResource(R.drawable.close);
                    listView2.setVisibility( View.VISIBLE );
                }else {
                    ImageButton_B.setImageResource(R.drawable.more);
                    ButtonB=false;
                    listView2.setVisibility( View.GONE );
                }
            }
